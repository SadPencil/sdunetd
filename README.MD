...
## Dynamic DNS
We recommend [TimothyYe/GoDNS](https://github.com/TimothyYe/godns).
Set `ip_interface` to your network interface, to help GoDNS get the real IPv4 address.
However, you can't use GoDNS behind a NAT router because the Internet traffic at SDU-Qingdao is being masqueradeed. If you do need this feature, open an issue at [sdunetd](https://github.com/SadPencil/sdunetd/issues) so that we can fork a special version of GoDNS which is suitable for SDU-Qingdao.
